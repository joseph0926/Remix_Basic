import { Link, useActionData, useSubmit, Form, useNavigation, useLoaderData, useMatches, useParams } from "@remix-run/react";
    ...
    <Form method={expenseData ? "patch" : "post"} className="form" id="expense-form">
      ...
      <div className="form-row">
        <p>
          ...
          <input type="number" id="amount" name="amount" min="0" step="0.01" defaultValue={defaultValue.amount} required />
        </p>
        <p>
